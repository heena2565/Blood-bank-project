...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                            ...
                            <div class="panel-body">
                                <form name="update_page" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div id="sample">
                                                <textarea cols="60" rows="10" id="area4" name="data"></textarea>                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                ...
                if(isset($_post['submit'])){
                    ...
                    echo '<div class="alert alert-success"><b>Page Data Updated.</b></div>';
                } 
                ?>
            </div>
        </div>
    ...
    <?php
          ...
          echo '<div class="alert alert-danger"><b>Please Login to access Admin Portal</b></div>';
  ?>    
