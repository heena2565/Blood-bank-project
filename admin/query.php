...
<head>
    ...
    <style>
        ...
        #sidebar{position:relative;margin-top:-10px; margin-bottom:20px;}
         ...
         <div class="table-responsive">
            ...
            <?php while($row = mysqli_fetch_assoc($result)){ ?>   
                ...
                <?php } else { ?>
                    ...
                    <a style="background-color:aqua" href="delete_queery.php?id=<?php echo $row['query_id']; ?>">Delete</a>
                </td>
                </tr>
                <?php } ?>
                </tbody>
...
<div class="table-responsive" style= "text-align:center; align:center;">
  ...
  if(mysqli_nums_rows($result1)>0){
    $total_records = mysqli_nums_rows($result1);
