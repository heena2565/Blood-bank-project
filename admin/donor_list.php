...
<head>
    ...
    <style>
      #sidebar{position:relative; margin-top:-15px;}
     #content{position:relative;margin-left:250px; margin-top:15px; width:80%;}
    ...
    echo '<div class="alert alert-danger"><b>PLease Login First To Access Admin Portal.<b></div>';
      ...
      <form method="post" name="" action="index.php" class="form-horizontal">
       <div class="form-group">
        ...
        <button class="btn btn-primary" name="submit" type="submit">Go to Log In page</button>
  </form>
  <?php } ?>
</body>
</html>