      ...
      <div class="container-fluid">
        ...
        <script>
          function clickme(){
            ...
            <?php 
            echo '<div class="alert alert-info alert-dismissibal"><b><button type="button" class="close" data-dismiss="alert">&times; </button></b><b>Pending Request "Read".</b></div>';
             $que_id=$_GET['id'];
       ...
       <div class="table-responsive">
        <table class="table table-bordered" style="text-align: center;">
           <thead style="text-align: center;">
            ...
            <th style="text-align: center;">Mobie number</th>
...
<div class="table-responsive" style="text-align: center;">
  <?php 
  $q ="select * from contact_query";
  $result_=mysqli_query($conn, $q) or die("Query Failed.");

  if(mysqli_num_rows($result_)>0){
    $total_Records= mysqli_num_rows($result_);
    ...
    if($page > 1){
      ...
      for($i=1; $i<=$total_pages; $i++){
        ...
        echo '<li><a href="query.php?page= '.$i.'">'.$i.'</a></li>';
