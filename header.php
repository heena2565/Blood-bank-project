            ...
            <div class="container">
                <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <i class="fas fa-phone-volume" style="border-right: 1px solid gray;"> +91 7837286361
                                &nbsp; &nbsp; </i>
                        </li>
                        <li class="nav-item">
                ...
                <div class="navbar-collapse collapse w-100 order-3 dual-collapse2">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="padding-left: 15px;" href="#">IN</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section id="Nav2">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <button class="btn signup" onclick= "window.location.href = 'need-blood.php';">Need Blood</button>
                <button class="btn login" onclick= "window.location.href = 'donate-blood.php';">Donate Blood</button>
            </div>
        </nav>
    </section>
    <!-- Navbar 2 End -->
